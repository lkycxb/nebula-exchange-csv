...
case class NebulaSourceConfigEntry(override val category: SourceCategory.Value,
                                   override val sentence: String, //tagName or edgeName
                                   graphHosts: String,
                                   metaHosts: String,
                                   space: String,
                                   user: String,
  ...
  require(graphHosts != null && metaHosts != null && space != null & user != null && password != null &&
    graphHosts.trim.nonEmpty && metaHosts.trim.nonEmpty && space.trim.nonEmpty && user.trim.nonEmpty)

  override def toString: String = {
    s"Nebula source host: ${graphHosts},metaHosts:${metaHosts}, port: ${space},user: ${user}, password: ${password}, sentence: ${sentence}"
  }
}
